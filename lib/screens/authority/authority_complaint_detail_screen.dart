...
class AuthorityComplaintDetailScreen extends StatefulWidget {
  const AuthorityComplaintDetailScreen({super.key});

  @override
  State<AuthorityComplaintDetailScreen> createState() =>
      _AuthorityComplaintDetailScreenState();
}

class _AuthorityComplaintDetailScreenState
    extends State<AuthorityComplaintDetailScreen> {
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      centerTitle: true,
      title: Text(
        _complaint.complainNumber ?? 'شكوى #${_complaint.id ?? '--'}',
      ...
      actions: [
        if (_complaint.canChat)
          IconButton(
            ...
            onPressed: () => _controller.openChat(_complaint),
  ...
  Widget _buildStatusBanner() {
    ...
    final label = _complaint.statusLabel;
  ...
  Widget _buildInfoCard() {
    return _SectionCard(
      ...
      children: [
        ...
        _InfoRow(label: 'الأولوية', value: _complaint.priority ?? 'عادية'),
        _InfoRow(
                    ...
                    if (_complaint.canChat) ...[
                      Expanded(
                        ...
                        child: _ActionButton(
                          ...
                          outlined: true,
                          onTap: () => _controller.openChat(_complaint),
                        ),
                      ),
                      const SizedBox(width: 10),
                    ],
...
class _ConfirmDialog extends StatelessWidget {
  ...
  const _ConfirmDialog({required this.onConfirm});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Text(
              'سيتم إغلاق الشكوى وإرسال إشعار للمواطن.\nإذا كانت هناك محادثة مفتوحة ستُغلق تلقائياً.',
              textAlign: TextAlign.center,
              style: TextStyle(
